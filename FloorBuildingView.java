...
public class FloorBuildingView extends GridPane {
    ...
    private Menu searchFloorMenu;
    private MenuItem basementItem;
    private MenuItem mainFloorItem;
    private MenuItem secondFloorItem;
    private MenuItem thirdFloorItem;
    private MenuItem fourthFloorItem;
    ...
    public MenuItem getBasementItem() { return basementItem; }
    public MenuItem getMainFloorItem() { return mainFloorItem; }
    public MenuItem getSecondFloorItem() { return secondFloorItem; }
    public MenuItem getThirdFloorItem() { return thirdFloorItem; }
    public MenuItem getFourthFloorItem() { return fourthFloorItem; }


    private Building       model;

    public FloorBuildingView(Building m) {
        model = m;
        ...
        //Add the menu
        menuBar = new MenuBar();
        searchFloorMenu = new Menu("Search Floor");
        basementItem = new MenuItem(model.getFloorPlan(4).getName());
        mainFloorItem = new MenuItem(model.getFloorPlan(0).getName());
        secondFloorItem = new MenuItem(model.getFloorPlan(1).getName());
        thirdFloorItem = new MenuItem(model.getFloorPlan(2).getName());
        fourthFloorItem = new MenuItem(model.getFloorPlan(3).getName());
        menuBar.getMenus().add(searchFloorMenu);
        searchFloorMenu.getItems().addAll(fourthFloorItem, thirdFloorItem, secondFloorItem, mainFloorItem,
                new SeparatorMenuItem(), basementItem);
        add(menuBar, 0, 0, 3, 1);
    }
